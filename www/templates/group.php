...
<div class="dcf-bleed dcf-pt-8 dcf-pb-8">
    <div class="dcf-wrapper">
        ...
        <form class="dcf-form dcf-max-w-lg" id="group-form" method="post">
        ...
        <?php if (isset($group->users)) { ?>
            ...
            <form class="dcf-form dcf-max-w-lg" id="user-form" method="post" action="<?php echo htmlspecialchars($lilurl->getBaseUrl(goController::ROUTE_PATH_GROUP_USER_ADD) . '/' . urlencode($groupID ?? '')); ?>">
