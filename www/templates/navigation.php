<ul>
    <?php if ($auth->isAuthenticated()): ?>
        ...
        <li><a href="<?php echo htmlspecialchars($lilurl->getBaseUrl('a/token-generator')); ?>">API Token</a></li>
        <li><a href="<?php echo htmlspecialchars($lilurl->getBaseUrl('a/logout')); ?>">Log out as <?php echo htmlspecialchars($auth->getUserDisplayName() ?? ''); ?></a></li>
    <?php else: ?>
