...
class UNL_Templates extends UNL_DWT
{
    ...
    {
        if ('/Users/bbieber/Documents/workspace/UNL_Go_URL/vendor/data' != '@DATA_DIR'.'@') {
            // pear/pyrus installation
            return '/Users/bbieber/Documents/workspace/UNL_Go_URL/vendor/data/UNL_Templates/data/';
        }
